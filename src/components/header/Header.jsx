...
import { useNavigate } from "react-router-dom";// to programmatically navigate to different routes
...
function Header() {
  ...
  return (
    <header className="py-3 shadow bg-gray-500 top-0 left-0 w-full z-50 ">
      <Container>
        <nav className="flex">
          <div className="mr-4">
            <Link to="/">
